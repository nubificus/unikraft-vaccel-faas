...
COPY data /data
COPY bin/qemu_run.sh .
COPY bin/bvlc_googlenet.caffemodel.1.1.7203.GPU.FP16.engine /usr/local/share/imagenet-models/networks/bvlc_googlenet.caffemodel.1.1.7203.GPU.FP16.engine
COPY bin/test_static .
